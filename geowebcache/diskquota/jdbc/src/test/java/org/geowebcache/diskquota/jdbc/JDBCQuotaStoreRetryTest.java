...
/**
 * Offline unit tests for the bounded-retry layer in {@link JDBCQuotaStore}.
 *
 * <p>Stubs out the underlying {@link TransactionTemplate} with a Mockito mock so the helper's loop behavior can be
 * verified without a real database: how many attempts it makes before propagating, how it preserves thread
 * interruption, and that non-concurrency exceptions skip the retry path entirely.
 */
